...
export default function ManageResearch({ researches, filters, programs, faculties, keywordOptions, agendas, sdgs, srigs }: Props) {
  ...
  const handleSearch = (query: string) => {
    router.get('/staff/research', query ? { search: query } : {}, { preserveState: true, preserveScroll: false })
  }
      ...
      <AppLayout>
        <div className="space-y-6 p-4 sm:p-6">
          <div className="mb-2 flex items-start justify-between gap-3">
            <div>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white tracking-tight">Manage Research</h2>

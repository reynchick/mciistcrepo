...
export default function ArchiveModal({ open, onOpenChange, title, program, year, onArchive, isLoading = false }: Props) {
        ...
        >
            <div className="space-y-3">
                <div className="text-sm">
                    ...
                    <div className="text-muted-foreground">{[program, year].filter(Boolean).join(' • ')}</div>
                </div>

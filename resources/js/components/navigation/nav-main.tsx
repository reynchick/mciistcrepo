...
const baseMenu: MenuItem[] = [
  ...
  {
  id: 'logs', label: 'View Logs', icon: FileText, route: '/logs/user-audit', roles: ['Administrator', 'MCIIS Staff'], activePattern: /^\/logs/,
    submenu: [
      ...
      { id: 'log-generated-reports', label: 'Generated Reports Log', icon: FileBarChart, route: '/logs/generated-reports', roles: ['Administrator', 'MCIIS Staff'], activePattern: /^\/logs\/generated-reports/ },
    ],
  },

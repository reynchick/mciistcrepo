...
export default function CompiledReportCard({ records, programs, years, advisers, statuses, filters }: ReportCardProps) {
	...
	const handlePreview = () => {
		...
		setPreviewUrl(`${apiPrefix()}/reports/export-compiled?${params.toString()}`);
		setPreviewOpen(true);
	};
	...
	const handleExport = (format: 'pdf' | 'docx') => {
		...
		window.location.href = `${apiPrefix()}/reports/export-compiled?${params.toString()}`;

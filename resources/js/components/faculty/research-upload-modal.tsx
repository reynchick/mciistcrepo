...
export default function ResearchUploadModal({ open, programs, faculties, keywordOptions, agendas, sdgs, srigs, currentFaculty, onClose, onCreated }: Props) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">You are automatically set as the adviser for research you upload.</p>
            </div>
